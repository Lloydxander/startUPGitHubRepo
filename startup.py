...
st.markdown("<h1 style = 'text-align: center; color: #EEEEEE'>START UP PROJECT</h1> ", unsafe_allow_html = True)
st.markdown("<h3 style = 'top_margin: 0rem; text-align: right; color: #BB2525'>Built by Lloydxander Wizard</h3>", unsafe_allow_html = True)

st.image('pngwing.com copy.png', width = 800)

st.markdown("<h3 style = 'top_margin: 0rem; text-align: center; colour #D80032'>PROJECT INTRODUCTION</h3>", unsafe_allow_html = True)
...
with pred_result:
    if st.button('Predict The Profit'):
